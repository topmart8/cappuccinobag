...
function addHomePrioritySections(html) {
  const hero = `<section class="hero home-stage" id="home-hero"><img class="hero-image" src="/assets/cappuccino-racquet-bag-lifestyle.jpg" alt="Cappuccino Bag outdoor sports, travel, racket, wallet and accessory OEM manufacturing scene" width="1672" height="941" fetchPriority="high"><div class="hero-overlay"></div><div class="hero-content"><p class="eyebrow">OEM/ODM Product Development</p><h1>Custom Racket Sports, Outdoor, Travel Bags &amp; Accessories</h1><p>Develop private-label bags and accessories with specification review, material sourcing, sampling, production, quality control and export packing support.</p><div class="hero-actions"><a class="btn btn-primary" href="/inquiry">Start Your Custom Bag Project</a><a class="btn btn-secondary" href="/products">Explore Product Collections</a></div></div></section>`;
  const buyerPaths = `<section class="section home-stage" id="buyer-paths"><div class="section-heading"><div><p class="eyebrow">Three Core Buyer Paths</p><h2>Start With the Product Program You Need</h2></div><p>Choose the closest product family, then compare formats and manufacturing requirements before requesting a sample.</p></div><div class="home-buyer-grid"><article><p class="eyebrow">Racket Sports</p><h3>Padel, Tennis &amp; Pickleball</h3><p>Racket bags, backpacks, duffels, shoe storage and court accessories developed around equipment fit and carry needs.</p><nav aria-label="Racket sports buyer path"><a href="/racket-sports/padel-bags">Padel Bags</a><a href="/custom-tennis-bag-manufacturer">Tennis Bags</a><a href="/custom-pickleball-paddle-bags">Pickleball Bags</a></nav></article><article><p class="eyebrow">Outdoor &amp; Travel</p><h3>Hiking, Backpacks &amp; Gear Bags</h3><p>Outdoor packs, travel backpacks, duffels and gear bags reviewed for capacity, carry, organization and packing.</p><nav aria-label="Outdoor and travel buyer path"><a href="/custom-outdoor-sports-bag-manufacturer">Outdoor &amp; Hiking Bags</a><a href="/custom-travel-backpacks-weekender-bags">Travel Bags</a></nav></article><article><p class="eyebrow">Wallets &amp; Accessories</p><h3>RFID, Card Holders &amp; Small Goods</h3><p>Wallets, card holders, passport covers and selected small accessories with branding and packaging options.</p><nav aria-label="Wallet and accessory buyer path"><a href="/rfid-wallet-passport-holder-manufacturer">RFID Wallets</a><a href="/custom-cardholder-manufacturer">Card Holders</a><a href="/custom-phone-pouch-manufacturer">Small Accessories</a></nav></article></div></section>`;
  const featuredProducts = `<section class="section home-stage home-featured" id="featured-products"><div class="section-heading"><div><p class="eyebrow">Featured Products</p><h2>Compare Proven Product Directions</h2></div><p>Use focused collection pages for product discovery and manufacturer pages when your specification is ready for sourcing review.</p></div><div class="home-featured-grid"><article class="home-featured-padel"><img src="/images/padel/cappuccino-padel-collection-2026-lifestyle.png" width="1672" height="941" loading="lazy" alt="Cappuccino Padel Collection 2026 racket bags, backpack, shoe bag and organizer"><div><p class="eyebrow">Racket Sports</p><h3>Custom Padel Bag Collection</h3><p>Compare racket duffels, backpacks, totes, shoe bags and organizers for coordinated Padel programs.</p><nav aria-label="Padel product paths"><a href="/racket-sports/padel-bags">Explore Padel Bags</a><a href="/custom-padel-bag-manufacturer">Padel Bag Manufacturer</a><a href="/custom-tennis-padel-racket-bags">Compare Racquet Sports Bags</a></nav></div></article><article><p class="eyebrow">Outdoor &amp; Travel</p><h3>Backpacks, Duffels &amp; Carry Systems</h3><p>Review hiking, travel and gear-bag formats before confirming capacity, organization, protection and carry requirements.</p><a class="home-text-link" href="/custom-outdoor-sports-bag-manufacturer">Explore Outdoor &amp; Hiking Bags</a></article><article><p class="eyebrow">Wallets &amp; Accessories</p><h3>RFID and Small Accessory Programs</h3><p>Develop coordinated wallets, card holders, passport covers and gift-ready accessories.</p><a class="home-text-link" href="/rfid-wallet-passport-holder-manufacturer">Explore RFID Wallets &amp; Accessories</a></article></div><a class="home-all-products" href="/products">View all product collections</a></section>`;
  const factoryProof = `<section class="section home-stage home-factory-proof" id="factory-development-proof"><div class="section-heading"><div><p class="eyebrow">Factory + Development Proof</p><h2>From Specification Review to Export Packing</h2></div><p>Sixteen years of bag, wallet and cardholder manufacturing experience supports practical OEM/ODM development for global B2B projects.</p></div><div class="home-proof-layout"><img src="/site/assets/factory-workshop-wide-hero.png" alt="Cappuccino Bag production workshop for custom bag development" width="1672" height="941" loading="lazy"><div><div class="home-proof-points"><span>Design and specification review</span><span>Material sourcing</span><span>Pattern and sample development</span><span>Pre-production approval</span><span>Bulk production</span><span>Quality inspection</span><span>Packing and export support</span></div><p>Project evidence can include workshop photos, sample updates, QC records and packing confirmation. Partner-audit, selected-sample testing and packaging-registration support apply only to qualified projects and the agreed scope.</p><a class="home-text-link" href="/factory-trust-materials">Review Factory &amp; Quality Proof</a></div></div></section>`;
  const caseStudies = `<section class="section home-stage" id="case-studies"><div class="section-heading"><div><p class="eyebrow">Case Studies</p><h2>Selected Buyer Project Experience</h2></div><p>Anonymous examples are used because customer names and logos are not shown without authorization.</p></div><div class="case-grid"><article class="case-card"><h3>European Padel Brand</h3><p><strong>Program:</strong> Padel racket bag and multifunctional sports bag.</p><p><strong>Work:</strong> Racket compartment, shoe pocket, durable fabric, branding, storage layout and retail-ready packing.</p></article><article class="case-card"><h3>Dutch Hotel Group</h3><p><strong>Program:</strong> Multifunctional backpack and trolley luggage.</p><p><strong>Work:</strong> Brand color matching, logo details, travel structure, packing confirmation and bulk production support.</p></article><article class="case-card"><h3>Wallet &amp; RFID Gift Set</h3><p><strong>Program:</strong> Wallets, RFID card holders and gift sets.</p><p><strong>Work:</strong> Logo, gift box packaging, RFID protection, color matching and retail-ready labels.</p></article></div><a class="home-all-products" href="/case-studies">Explore more case studies</a></section>`;
  const materials = `<section class="section home-stage home-materials" id="material-capabilities"><div class="section-heading"><div><p class="eyebrow">Material Capabilities</p><h2>Material Options Selected for Each Project</h2></div><p>Recycled polyester, recycled nylon, vegan leather, apple leather, pineapple-based materials, washable kraft paper, Alcantara and genuine leather can be reviewed against the product brief.</p></div><p class="home-material-note">Certified or documented material options are subject to the selected supplier, material batch and project requirements.</p><a class="home-text-link" href="/recycled-material-bags">Review material directions</a></section>`;
  const projectCta = `<section class="inquiry-section home-stage home-project-cta" id="project-cta"><div class="inquiry-copy"><p class="eyebrow">RFQ / Project Brief</p><h2>Start Your Custom Bag Project</h2><p>Share the product category, target quantity, dimensions, material direction, branding, packaging and timeline for a practical development review.</p></div><div class="home-project-actions"><a class="btn btn-primary" href="/inquiry">Start Your Custom Bag Project</a><a class="btn btn-secondary" href="/products">Explore Product Collections</a></div></section>`;
  const homepage = `${hero}${buyerPaths}${featuredProducts}${factoryProof}${caseStudies}${materials}${projectCta}`;
  return html.replace(/<main\b[^>]*>[\s\S]*?<\/main>/i, `<main id="top">${homepage}</main>`);
}
