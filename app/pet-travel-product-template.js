...
import { JsonLd, Link, PetActions, PetBreadcrumb, PetProductCard, PetProductVisual, PetShell, QuotationChecklist } from "./pet-travel-components";
...
export async function getPetProductMetadata(slug) {
  ...
  return { title: product.metaTitle, description: product.metaDescription, alternates: { canonical }, openGraph: { title: product.metaTitle, description: product.metaDescription, url: canonical, type: "website", images: [{ url: `${petSiteUrl}/assets/cappuccino-outdoor-bag-factory-workshop.jpg`, width: 1600, height: 900, alt: "Cappuccino Bag factory workshop for custom bag development" }] }, twitter: { card: "summary_large_image", title: product.metaTitle, description: product.metaDescription, images: ["/assets/cappuccino-outdoor-bag-factory-workshop.jpg"] }, robots: { index: true, follow: true } };
}
