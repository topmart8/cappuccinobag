...
export function normalizeImportRow(raw = {}, context = {}) {
  ...
  const identity = identityCandidates({ ...normalized, whatsapp: normalized.whatsapp_phone });
  const errors = [];
  ...
  return {
    normalized: {
      ...normalized,
      domain: identity.domain || identifiers.domain || null,
      email_normalized: identity.email || null,
      phone_normalized: identity.phone || null,
      whatsapp_phone: identity.whatsapp || null,
      website_normalized: identity.website || null,
      company_normalized: identity.company || null,
      score: scored.final,
    },
    identifiers,
    errors,
