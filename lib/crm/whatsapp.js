...
export async function sendCloudMessage(to, body, approvalContext = {}) {
  requireHumanApprovedOutbound(approvalContext);
...
async function handleInbound(message) {
  ...
  const configuredMode = process.env[
    selectedBrand.site === "cappuccinobag" ? "CAP_WHATSAPP_REPLY_MODE" : "NOV_WHATSAPP_REPLY_MODE"
  ];
